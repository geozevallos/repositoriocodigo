    ...
    >
      <figure className="curso__imagen">
        {props.objCurso.descuento > 0 ? (
          <p className="curso__descuento">{props.objCurso.descuento}%</p>
        ) : null}
      ...
      <div className="curso__info">
        ...
        <p className="curso__descripcion">{props.objCurso.descripcion}</p>
        <div className="curso__caracteristicas">
          <span>
            <i className="fas fa-clock"></i> {props.objCurso.duracion} horas
          </span>
          <span>
            <i className="fas fa-money-check "></i> {props.objCurso.precio}{" "}
            dólares
          </span>
