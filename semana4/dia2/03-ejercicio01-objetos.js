let peliculas = [
  ...
  /**
   * Función que retorna la cantidad de peliculas
   * en el idioma ingles
   */
...
//   console.log(`El número de peliculas en inglés es: ${peliculasEnIngles()}`);
...
console.log(`El número de peliculas en el idioma: ${peliculasPorIdioma("ko")}`);


/**
 * Funcion que importe el nombre de la pelicula con mas generos
...
function peliculasGeneros(){
    ...
    console.log(`La pelicula con más generos es ${nombre} y tiene ${generos}`);
}
